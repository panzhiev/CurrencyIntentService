...
public class EURAdapter extends BaseAdapter {

    Context mContext;
    List<Organization> list;
    LayoutInflater inflater;

    public EURAdapter(Context context, List<Organization> list) {
        mContext = context;
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null)
            view = inflater.inflate(R.layout.eur_item, parent, false);//задаем вью нашу разметку
        ...
        ((TextView) view.findViewById(R.id.tv_ask_eur_value)).setText(String.valueOf(organization.getEurASK()));
        ((TextView) view.findViewById(R.id.tv_bid_eur_value)).setText(String.valueOf(organization.getEurBID()));
        return view;
    }
}
