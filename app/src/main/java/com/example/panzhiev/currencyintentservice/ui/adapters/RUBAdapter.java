...
public class RUBAdapter extends BaseAdapter {
    Context mContext;
    List<Organization> list;
    LayoutInflater inflater;

    public RUBAdapter (Context context, List<Organization> list) {
        mContext = context;
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null)
            view = inflater.inflate(R.layout.rub_item, parent, false);//задаем вью нашу разметку
        ...
        ((TextView) view.findViewById(R.id.tv_ask_rub_value)).setText(String.valueOf(organization.getRubASK()));
        ((TextView) view.findViewById(R.id.tv_bid_rub_value)).setText(String.valueOf(organization.getRubBID()));
        return view;
    }
}
